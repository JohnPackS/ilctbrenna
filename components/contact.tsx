            ...
            <CardContent className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="+244 930 345 666; +244 939 758 854" className="text-muted-foreground hover:text-primary transition-colors">
                    +244 930 345 666; +244 939 758 854
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a
                    href="mailto:ilctbrennna930@gmail.com"
                    className="text-muted-foreground hover:text-primary transition-colors"
                  >
                    ilctbrennna930@gmail.com
                  </a>
                </div>
              </div>
